  ...
  return (
    <section className="bg-white">
      <div className="container">
        ...
        <div className="flex gap-6 justify-center mt-10 [mask-image:linear-gradient(to_bottom,transparent,black_25%,black_75%,transparent)] max-h-[738px] overflow-y-hidden">
